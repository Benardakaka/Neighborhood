...
##### Cloning the repository:  
 ```bash 
https://github.com/Benardakaka/Neighborhood.git
```
...
* [Django .2.6](https://docs.djangoproject.com/en/2.2/)  
...
* [![License](https://img.shields.io/packagist/l/loopline-systems/closeio-api-wrapper.svg)](https://github.com/Benardakaka/Neighborhood/blob/master/LICENSE)  
